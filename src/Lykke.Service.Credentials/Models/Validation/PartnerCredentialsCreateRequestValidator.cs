...
{
    public class PartnerCredentialsCreateRequestValidator : AbstractValidator<PartnerCredentialsCreateRequest>
    {
        public PartnerCredentialsCreateRequestValidator(IPasswordValidator passwordValidator)
        {
